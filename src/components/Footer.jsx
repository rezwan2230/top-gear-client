...
const Footer = () => {
    return (
        <footer className="px-4 divide-y bg-gray-200 dark:bg-gray-800 dark:text-gray-100 md:mt-10  md:h-[360px] lg:h-[290px]">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-bold">Top Gear</span>
                    </a>
                </div>
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    <div className="space-y-3">
                        <h3 className="tracki uppercase dark:text-gray-50">Page</h3>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">©Khan  Company Co. All rights reserved.</div>
        </footer>
    );
};
